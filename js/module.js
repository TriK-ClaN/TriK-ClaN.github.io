...
exports.default = {
    ...
    celeImgs: [document.getElementById('mm-smile'), document.getElementById('mm-movie'), document.getElementById('mm-music'), document.getElementById('mm-kiss'), document.getElementById('mm-dance')]
};
...
exports.default = {
    ...
    more: [{
        answer: 'KURIOS',
        questions: ['Which Cirque du Soleil production did we visit?', 'What is the capital of France?', 'Who invented the light bulb?', 'What is the largest planet in our solar system?', 'Who wrote "Pride and Prejudice"?', 'What color is a typical school bus?', 'Who painted the ceiling of the Sistine Chapel?', 'What is the main ingredient in guacamole?', 'Who was the first President of the United States?', 'What is the speed of light?']
    }, {
        answer: 'Eclair au Chocolat',
        questions: ['What was my favorite pastry from the bakery?', 'What is the square root of 144?', 'Who discovered penicillin?', 'What is the chemical symbol for water?', 'Who directed "Jurassic Park"?', 'What is the capital of Japan?', 'What animal is known as the "King of the Jungle"?', 'What is the primary language spoken in Brazil?', 'Who is the author of "1984"?']
    }, {
        answer: 'Turtleneck',
        questions: ['Which clothing item of mine did you borrow?', 'What is the powerhouse of the cell?', 'What is the longest river in the world?', 'Who was the first person to walk on the moon?', 'What is the boiling point of water?', 'What is the hardest natural substance on Earth?', 'What is the smallest prime number?', 'What planet is known as the Red Planet?']
    }, {
        answer: 'Ann Liang',
        questions: ['Who is the author of your favorite novel?', 'What is the tallest mountain in the world?', 'Who painted "Starry Night"?', 'What is the capital of Canada?', 'What is the main ingredient in sushi?', 'Who developed the theory of relativity?', 'What is the largest mammal?']
    }, {
        answer: 'Pancake',
        questions: ['Which plushie gift of mine was your favorite?', 'What is the national sport of Canada?', 'What is the tallest building in the world?', 'What is the capital city of Australia?', 'What is the largest ocean on Earth?', 'What is the main ingredient in hummus?']
    }, {
        answer: 'Kintaro',
        questions: ['What is now my favorite restaurant?', 'What is the capital of Italy?', 'Who is known as the "Father of Computers"?', 'What is the primary ingredient in chocolate?', 'Who painted the "Mona Lisa"?']
    }, {
        answer: 'Watermelon',
        questions: ['Which flavor of Sour Patch Kids was our favorite?', 'What is the speed of sound?', 'Who invented the World Wide Web?', 'What is the main ingredient in bread?']
    }, {
        answer: 'Christmas Market',
        questions: ['Where did we search for cotton candy?', 'What is the chemical symbol for gold?', 'Who was the first man in space?']
    }, {
        answer: 'Hunger Games',
        questions: ['Which movie did we watch together at the cinema?', 'Who discovered gravity?']
    }, {
        answer: 'YES!',
        questions: ['Ha Linh, did you know I love you times infinity?']
    }],    
    nextQuestion: function nextQuestion() {
